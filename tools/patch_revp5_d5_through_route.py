...
new = '''    # Rev.P5 product circulation is one continuous one-way route. From the
    ...
    # D3 centreline.  The exact intersection is (557.0394602, 150.0).  Ending
    # the D5 axis at this first crossing prevents it from entering the stacked
    # D3 hairpins and eliminates every disconnected far-side road fragment.
...
print("REV_P5_D5_FIRST_CROSSING_JUNCTION_PATCHED")
